...
import { Bot, Mail, Lock, ArrowRight, Github, Twitter } from "lucide-react"
    ...
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative isolate px-6 pt-32 pb-20">
        <div className="mx-auto max-w-sm">
          ...
          {/* Login Form - No card, blended into page */}
          <form className="space-y-5">
            ...
            <div className="flex items-center justify-between px-1">
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded-md border-border/60 bg-background/40 text-primary focus:ring-primary/30 focus:ring-offset-0"
                />
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-background/80 backdrop-blur-sm px-4 text-muted-foreground/70">or continue with</span>
            </div>
          </div>

          {/* Social Login - Pill style like navbar */}
